%%
%% This is file `socius_conference_paper_v5.tex',
%%
...
The synthesis of these pillars produces four distinct, recurring themes that structure our scenario database. Each theme has a defined conflict, formula, and goal.
